...
import { getEquipmentByHall, updateEquipmentCondition, getComponentsByHall, updateComponentStatus } from "@/actions/equipments"
...
export const useUpdateEquipmentCondition = () => {
  ...
  return useMutation({
    mutationFn: ({
      ...
      techStaffId: string
      notes?: string
    }) => updateEquipmentCondition(equipmentId, newCondition, techStaffId, notes),
    onSuccess: () => {
