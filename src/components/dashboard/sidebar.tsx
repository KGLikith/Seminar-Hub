...
const menuItems = {
  [UserRole.teacher]: [
    ...
    { label: "Book Seminar", href: "/dashboard/book", icon: BookOpen },
    { label: "My Bookings", href: "/dashboard/teacher/bookings", icon: Book },
    { label: "Calendar", href: "/dashboard/calendar", icon: Calendar },
    { label: "Recent Events", href: "/dashboard/recent-events", icon: LayoutDashboard },
  ...
  [UserRole.hod]: [
    ...
    { label: "Book Seminar", href: "/dashboard/book", icon: BookOpen },
    { label: "Calendar", href: "/dashboard/calendar", icon: Calendar },
    { label: "Pending Requests", href: "/dashboard/approval", icon: BookOpen },
    { label: "Usage Statistics", href: "/dashboard/hod/analytics", icon: BarChart3 },
    { label: "Department Management", href: "/dashboard/hod/department-management", icon: BarChart3 },
    { label: "Hall Management", href: "/dashboard/hod/hall-management", icon: BarChart3 },
    { label: "Recent Events", href: "/dashboard/recent-events", icon: LayoutDashboard },
    { label: "Profile", href: "/dashboard/profile", icon: User },
