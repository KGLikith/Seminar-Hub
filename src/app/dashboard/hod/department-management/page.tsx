...
const DepartmentManagement = () => {
    ...
    const { data: halls, isLoading: hallsLoading, refetch: HallsRefetch } = useDepartmentHalls(profile?.department_id ?? undefined);
    const { data: users, isLoading: usersLoading } = useGetUsersFromDepartment(profile?.department_id ?? undefined);
    const { data: assignments, isLoading: assignmentsLoading, refetch: assignmentsRefetch } = useGetTechStaffAssignments(profile?.department_id ?? undefined);
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground">
                        Manage teachers and tech staff in your department
                    </p>
                </div>
                ...
                <div className="grid gap-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Assign tech staff to manage seminar halls
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-3">
